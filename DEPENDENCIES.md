# go-pantheon/lares dependencies

The following open source dependencies are used to build the [go-pantheon/lares][].
...
Some packages may only be included on certain architectures or operating systems.
 ...
 - [github.com/go-pantheon/fabrica-net/http/health](https://pkg.go.dev/github.com/go-pantheon/fabrica-net/http/health) ([MIT](https://github.com/go-pantheon/fabrica-net/blob/HEAD/LICENSE))
 ...
 - [github.com/go-pantheon/lares](https://pkg.go.dev/github.com/go-pantheon/lares) ([MIT](https://github.com/go-pantheon/lares/blob/HEAD/LICENSE))
 ...
 - [github.com/huandu/facebook/v2](https://pkg.go.dev/github.com/huandu/facebook/v2) ([MIT](https://github.com/huandu/facebook/blob/v2.9.1/LICENSE))
